...
DccObject {
    ...
    DccObject {
        ...
        SectionGeneric {
            Accessible.id: "SectionGeneric_3"
    ...
    DccObject {
        ...
        DccObject {
            ...
            page: NetButton {
                Accessible.id: "PageSettings_NetButton"
            ...
            D.DialogWindow {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        D.Button {
                            Accessible.id: "Component_Button_3"
                            Layout.fillWidth: true
                            contentItem: D.IconLabel {
                                text: qsTr("Delete")
                                color: "red"
