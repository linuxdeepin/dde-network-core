...
DccObject {
    ...
    DccObject {
        ...
        DccObject {
            ...
            page: D.ComboBox {
                Accessible.id: "PageVpnsettings_ComboBox"
                flat: true
                textRole: "text"
                valueRole: "value"
    ...
    DccObject {
        ...
        DccObject {
            ...
            visible: config && config.connection.uuid !== "{00000000-0000-0000-0000-000000000000}"
            page: NetButton {
                Accessible.id: "PageVpnsettings_NetButton"
            ...
            D.DialogWindow {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        D.Button {
                            Accessible.id: "Component_Button"
                            Layout.fillWidth: true
                            contentItem: D.IconLabel {
                                text: qsTr("Delete")
                                color: "red"
