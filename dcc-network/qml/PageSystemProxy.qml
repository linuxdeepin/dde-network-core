...
DccObject {
    ...
    Component {
        id: devCheck
        D.Switch {
            Accessible.id: "Component_Switch_2"
    ...
    DccObject {
        ...
        DccObject {
            ...
            DccObject {
                ...
                page: D.Switch {
                    Accessible.id: "PageSystemProxy_Switch"
            ...
            DccObject {
                ...
                pageType: DccObject.Editor
                page: ComboBox {
                    Accessible.id: "PageSystemProxy_ComboBox"
                    flat: true
                    textRole: "text"
                    valueRole: "value"
        ...
        DccObject {
            ...
            DccObject {
                ...
                pageType: DccObject.Item
                page: Button {
                    Accessible.id: "DccObjDisplayName"
