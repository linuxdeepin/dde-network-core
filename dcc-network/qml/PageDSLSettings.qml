...
DccObject {
    ...
    DccObject {
        ...
        SectionGeneric {
            Accessible.id: "SectionGeneric_2"
    ...
    DccObject {
        ...
        DccObject {
            ...
            page: NetButton {
                Accessible.id: "PageDslsettings_NetButton"
            ...
            D.DialogWindow {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        D.Button {
                            Accessible.id: "Component_Button_2"
                            Layout.fillWidth: true
                            contentItem: D.IconLabel {
                                text: qsTr("Delete")
                                color: "red"
