...
DccObject {
    ...
    page: DeviceStatusItem {
        Accessible.id: "PageWiredDevice_DeviceStatusItem"
    ...
    DccObject {
        ...
        DccObject {
            ...
            DccObject {
                ...
                page: DeviceStatusItem {
                    Accessible.id: "PageWiredDevice_DeviceStatusItem_2"
                    Accessible.role: Accessible.Grouping
                    netItem: root.netItem
                    statusVisible: false
                }
                        ...
                        delegate: ItemDelegate {
                            ...
                            contentItem: ColumnLayout {
                                RowLayout {
                                    ...
                                    NetButton {
                                        Accessible.id: "ModelItemStatus_2"
