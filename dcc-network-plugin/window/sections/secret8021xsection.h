...
public:
    explicit Secret8021xEnableWatcher(QObject *parent = nullptr)
        : QObject(parent), m_secretEnabled(false) {}
...
private:
    ...
    void initEapMethodTlsItems(QList<DCC_NAMESPACE::SettingsItem *> *itemList);
    void initEapMethodFastItems(QList<DCC_NAMESPACE::SettingsItem *> *itemList);
    void initEapMethodTtlsItems(QList<DCC_NAMESPACE::SettingsItem *> *itemList);
    void initEapMethodPeapItems(QList<DCC_NAMESPACE::SettingsItem *> *itemList);
...
private:
    ...
    DCC_NAMESPACE::ComboxWidget *m_eapMethmodChooser;
    DCC_NAMESPACE::LineEditWidget *m_identity;
    ...
    QMap<Security8021xSetting::EapMethod, QList<DCC_NAMESPACE::SettingsItem *>> m_eapMethodItemsMap;
