...
>>>>>>> b6b2900 (fix: 修复了代理与端口之间控件使用不对的问题)
    ...
    appProxyModuleGroup->appendChild(new WidgetModule<DTipLabel>("app_proxy_tip", tr("Check \"Use a proxy\" in application context menu in Launcher after configured"), [](DTipLabel *tip) {
    ...
    extra->setExtra();
    appProxyModuleGroup->appendChild(extra);
